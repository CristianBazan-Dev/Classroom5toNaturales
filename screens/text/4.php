...
<div class="grid-container" id="content">
    ...
    <main>
        ...
        <div class="text-page">
                ...
                <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                    <p class="text-paragraph">
                        Amadeo Peralta se crió en la pandilla de su padre y llegó a ser un matón, como todos los 
                        hombres de su familia. Su padre opinaba que los estudios son para maricones, no se 
                        requieren libros para triunfar en la vida, sino cojones y astucia, decía, por eso formó a sus 
                        hijos en la rudeza. Con el tiempo, sin embargo, comprendió que el mundo estaba 
                        cambiando muy rápido y que sus negocios necesitaban consolidarse sobre bases más 
                        estables. La época del 
                        <button class="text-paragraph definition" id="pillaje">pillaje</button> 
                        desenfadado había sido reemplazada por la corrupción y el despojo solapado, era hora de administrar la riqueza con criterio moderno y mejorar su imagen. Reunió a sus hijos y les impuso la tarea de hacer amistad con personas influyentes y aprender asuntos legales, para que siguieran prosperando sin peligro de que les fallara la impunidad. También les encomendó buscar novias entre los apellidos más antiguos de la región, a ver si lograban lavar el nombre de los Peralta de tanta salpicadura de barro y de sangre. Para entonces Amadeo había cumplido treinta y dos años y tenía muy arraigado el hábito de seducir muchachas para luego abandonarlas, de modo que la idea del matrimonio no le gustó nada, pero no se atrevió a desobedecer a su padre. Comenzó a cortejar a la hija de un <button class="text-paragraph definition" id="hacendado">hacendado</button> cuya familia había vivido en el mismo lugar por seis generaciones. A pesar de la turbia fama del pretendiente, ella lo aceptó, porque era muy poco agraciada y temía quedarse soltera.</p>
                    </p>
                    <br>
                    <p class="text-paragraph resource">
                    ...
                    <br>
                    <p class="text-paragraph resource">
                        Pocas semanas antes de la boda, Amadeo Peralta tuvo que hacer un viaje de negocios por la provincia. Así llegó a Agua santa, uno de esos lugares donde nadie se queda y cuyo nombre los viajeros rara vez recuerdan. Pasaba por una calle angosta, a la hora de la siesta, maldiciendo el calor y ese olor dulzón de mermelada de mangos que agobiaban el aire, cuando escuchó un sonido cristalino como de agua deslizándose entre piedras, que provenía de una casa modesta, con la pintura descascarada por el sol y la lluvia, como casi todas por allí.A través de la reja divisó un <button class="text-paragraph definition" id="zaguan">zaguán</button> de baldosas oscuras y paredes encaladas, al fondo un patio y más allá la visión sorprendente de una muchacha sentada en el suelo con las piernas cruzadas, sosteniendo sobre las rodillas un <button class="text-paragraph definition" id="salterio">salterio</button> de madera rubia. Se quedó un rato observándola</p>.
                    </p>
        ...
        <div class="text-page">
                <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                    ...
                    <br>
                    <p class="text-paragraph resource">
                        No estaba dispuesto a dar explicaciones. Era hombre de palabra autoritaria, <button class="text-paragraph definition" id="patriarca">patriarca</button> y bisabuelo, nadie se atrevía a mirarlo a los ojos y hasta los curas lo saludaban con la cabeza inclinada. En su larga vida acrecentó la fortuna heredada de su padre, se adueñó de todas las tierras desde las ruinas del fuerte español hasta los límites del Estado y después se lanzó a una carrera política que lo convirtió en el cacique más poderoso de la zona. Se casó con la hija fea del hacendado , con ella tuvo nueve descendientes legítimos y con otras mujeres engendró un número impreciso de bastardos, sin guardar recuerdos de ninguna porque tenía el corazón definitivamente mutilado para el amor.
                    </p>
         ...
         <div class="text-page">
            <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                <p class="text-paragraph">
                     A la única que no pudo descartar del todo fue a Hortensia, porque se le quedó pegada en la conciencia como una persistente pesadilla. Después del breve encuentro con ella entre las yerbas de un terreno baldío, regresó a su casa, su trabajo y su desabrida novia de familia honorable.
                </p>
                <br>
                <p class="text-paragraph resource">
                    Fue Hortensia quien lo buscó hasta encontrarlo, fue ella quien se le atravesó por delante y se aferró a su camisa con una aterradora sumisión de esclava. Vaya lío, pensó él entonces, yo a punto de casarme con <button class="text-paragraph definition" id="pompaFanfarria">pompa y fanfarria</button> y esta niña desquiciada se me cruza en el camino. Quiso deshacerse de ella, pero al verla con su vestido amarillo y sus ojos suplicantes le pareció un desperdicio no aprovechar la oportunidad y decidió esconderla mientras se le ocurría alguna solución. Y así, casi por descuido, Hortensia fue a parar al sótano del antiguo ingenio de azúcar de los Peralta, donde permaneció enterrada durante toda su vida. Era un recinto amplio, húmedo, oscuro asfixiante en verano y frío en algunas noches de la temporada seca, amoblado con unos cuantos <button class="text-paragraph definition" id="trastosJergon">trastos y un jergón</button>. Amadeo Peralta no se dio tiempo para acomodarla mejor, a pesar de que algunas veces acarició la fantasía de convertir a la muchacha en una concubina de cuentos orientales, envuelta en tules leves y rodeada de plumas de pavo real, <button class="text-paragraph definition" id="cenefaBrocado">cenefas de brocado</button>, lámparas de vidrios pintados, muebles dorados de patas torcidas y alfombras peludas donde él pudiera caminar descalzo. Tal vez lo habría hecho si ella le hubiera recordado sus promesas, pero Hortensia era como un pájaro nocturno, uno de esos <button class="text-paragraph definition" id="guacharos">guácharos</button> ciegos que habitan al fondo de las cuevas, sólo necesitaba un poco de alimento y agua. El vestido amarillo se le pudrió en el cuerpo y acabó desnuda.
                </p>
                <br>
                <p class="text-paragraph resource">
                ...
                <br>
                <p class="text-paragraph resource">
                    Las primeras semanas Amadeo pasó mucho tiempo en el sótano con ella, saciando su apetito que creyó inagotable. Temiendo que la descubrieran y celoso hasta de sus propios ojos, no quiso exponerla a la luz natural y sólo dejó entrar un rayo tenue a través de la <button class="text-paragraph definition" id="claraboya">claraboya de ventilación</button>. En la oscuridad retozaron en el mayor desorden de los sentidos, con la piel ardiente y el corazón convertido en un cangrejo hambriento. Allí los olores y sabores adquirían una cualidad extrema. Al tocarse en las tinieblas lograban penetrar en la esencia del otro y sumergirse en las intenciones más secretas. En ese lugar sus voces resonaban con un eco repetido, las paredes les devolvían ampliados los murmullos y los besos. El sótano se convirtió en un frasco sellado donde se revolcaron como gemelos traviesos navegando en aguas amnióticas, dos criaturas turgentes y aturdidas. 
                </p>
         ...
         <div class="text-page">
            <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                ...
                <br>
                <p class="text-paragraph">
                    Cuando Hortensia se dormía, su amante salía a buscar algo de comer y antes de que ella despertara regresaba con renovados <button class="text-paragraph definition" id="brios">bríos</button> a abrazarla de nuevo. Así debieron amarse hasta morir derrotados por el deseo, debieron devorarse el uno al otro o arder como una antorcha doble pero nada de eso ocurrió. En cambio, sucedió lo más previsible y cotidiano, lo menos grandioso. Antes de un mes, Amadeo Peralta se cansó de los juegos, que ya empezaban a repetirse, sintió la humedad royéndole las articulaciones y comenzó a pensar en todo lo que había al otro lado del <button class="text-paragraph definition" id="antro">antro</button>. Era hora de volver al mundo de los vivos y recuperar las riendas de su destino.
                </p>
                <br>
                <p class="text-paragraph">
                    –Espérame aquí, niña. Voy afuera a hacerme muy rico. Te traeré regalos, vestidos y joyas de reina –le dijo al despedirse.
                <br>–Quiero hijos –dijo Hortensia.
                <br>–Hijos no, pero tendrás muñecas.

                </p>
                <br>
                <p class="text-paragraph resource">
                    En los meses siguientes Peralta se olvidó de los vestidos, las joyas y las muñecas. Visitaba a Hortensia cada vez que se acordaba, no siempre para hacer el amor, a veces sólo para oírla tocar alguna melodía antigua en el salterio, le gustaba verla inclinada sobre el instrumento pulsando las cuerdas. En ocasiones llevaba tanta prisa que no alcanzaba a cruzar ni una palabra con ella, le llenaba los <button class="text-paragraph definition" id="cantaros">cántaros</button> de agua, le dejaba una bolsa de provisiones y partía. Cuando se olvidó de hacerlo por nueve días y la encontró moribunda, comprendió la necesidad de conseguir alguien que lo ayudara a cuidar a su prisionera, porque su familia, sus viajes, sus negocios y sus compromisos sociales lo mantenían muy ocupado. Una india <button class="text-paragraph definition" id="hermetica">hermética</button> le sirvió para este fin. Ella guardaba la llave del candado y entraba regularmente a limpiar el calabozo y limpiar los <button class="text-paragraph definition" id="liquenes">líquenes</button> que le crecían a Hortensia en el cuerpo como una flora delicada y pálida, casi invisible al ojo desnudo, olorosa a tierra removida y a cosa abandonada
                </p>
         ...
         <div class="text-page">
            <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                <p class="text-paragraph resource">
                    –¿No tuvo lástima de esa pobre mujer? –le preguntaron a la india cuando también a ella se la llevaron detenida, acusada de complicidad en el secuestro, pero ella no contestó y se limitó a mirar de frente con ojos <button class="text-paragraph definition" id="impavidos">impávidos</button> y lanzar un escupitajo negro de tabaco.
                </p>
                <br>
                <p class="text-paragraph resource">
        ...
        <div class="text-page">
            <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                ...
                <p class="text-paragraph resource">
                  ...
                  <br>
                <p class="text-paragraph">
                    Una tarde de mucho calor, tres niños se escaparon de la escuela para bañarse en el río. Pasaron un par de horas chapoteando en el lodo de la orilla y luego se fueron a vagar cerca del antiguo ingenio de azúcar de los Peralta, cerrado desde hacía dos generaciones, cuando la caña dejó de ser rentable. El lugar tenía fama de hechizado, decían que se escuchaban ruidos de demonios y muchos habían visto por allí a una bruja <button class="text-paragraph definition" id="desgreñadas">desgreñada</button> invocando a las ánimas de los esclavos muertos. Exaltados por la aventura, los muchachos se metieron en la propiedad y se acercaron al edificio de la fábrica. Pronto se atrevieron a entrar en las ruinas, recorrieron los amplios cuartos de anchas paredes de adobe y vigas roídas por el <button class="text-paragraph definition" id="comejen">comején</button>, sortearon la maleza crecida del suelo, los cerros de basura y mierda de perro, las tejas podridas y los nidos de culebras. Dándose valor a fuerza de bromas, empujándose, llegaron hasta la sala de <button class="text-paragraph definition" id="molienda">molienda</button>, una habitación enorme abierta al cielo, con restos de máquinas despedazadas, donde la lluvia y el sol habían creado un jardín imposible y donde creyeron percibir un rastro penetrante de azúcar y sudor. Cuando empezaba a quitárseles el susto, oyeron con toda claridad un canto monstruoso. Temblando, trataron de retroceder, pero la atracción del horror pudo más que el miedo y se quedaron agazapados escuchando hasta que la última nota se les clavó en la frente. Poco a poco lograron vencer la inmovilidad, se sacudieron el espanto y empezaron a buscar el origen de esos extraños sonidos, tan diferentes a cualquier música conocida, y así dieron con una pequeña trampa a ras del suelo, cerrada con un candado que no pudieron abrir. Sacudieron la plancha de madera que cerraba la entrada y un indescriptible olor a fiera 
                </p>
        ...
        <!-- Page 7 -->
         <div class="text-page">
            <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                <p class="text-paragraph">
                    enjaulada les golpeó la cara. Llamaron, pero nadie respondió, sólo oyeron al otro lado un sordo <button class="text-paragraph definition" id="jadeo">jadeo</button>. Entonces partieron corriendo a avisar a gritos que habían descubierto la puerta del infierno. El <button class="text-paragraph definition" id="barullo">barullo</button> de los niños no pudo ser acallado y así los vecinos comprobaron finalmente lo que sospechaban desde hacía décadas. Primero llegaron las madres detrás de sus hijos a atisbar por las ranuras de la trampa, y ellas también escucharon las notas terribles del salterio, muy diferentes a la melodía banal que atrajo a Amadeo Peralta al detenerse en una callejuela de Agua Santa para secarse el sudor de la frente. Detrás de ellas acudió un tropel de curiosos y por último, cuando ya se había juntado una muchedumbre, aparecieron los policías y los bomberos, que hicieron saltar la puerta a hachazos y se metieron al hoyo con sus lámparas y sus bártulos de incendio. En la cueva encontraron a una criatura desnuda, con la piel flácida colgando en pálidos pliegues, que arrastraban unos mechones grises por el suelo y gemía aterrorizada por el ruido y la luz. Era Hortensia, brillando con fosforescencia de <button class="text-paragraph definition" id="madreperla">madreperla</button> bajo las linternas <button class="text-paragraph definition" id="implacables">implacables</button> de los bomberos, casi ciega, con los dientes gastados y las piernas tan débiles que casi no podía tenerse de pie. La única señal de su origen humano, era un viejo salterio apretado contra su regazo.
                </p>
                <br>
                <p class="text-paragraph">
                ...
                <br>
                <p class="text-paragraph">
                    Aprovechando el furor público atizado por la prensa, los numerosos enemigos de Amadeo Peralta reunieron por fin el valor para lanzarse en picada en su contra. Las autoridades, 
                </p>
        ...
        <div class="text-page">
            <div class="paragraph-header">Si me tocaras el corazón - Isabel Allende</div>
                ...
                <br>
                <p class="text-paragraph">
                    Cada día, a las diez de la mañana, Hortensia caminaba con su vacilante paso de loca hasta el penal y le entregaba al vigilante de la puerta una <button class="text-paragraph definition" id="marmita">marmita</button> caliente para el preso.
                </p>
                <br>
                <p class="text-paragraph">
