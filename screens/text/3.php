...
<div class="grid-container" id="content">
    ...
    <main>
        ...
        <div class="text-page">
            <div class="paragraph-header">Una venganza - Isabel Allende</div>
            <p class="text-paragraph">
                Cuando se calló el <button class="text-paragraph definition" id="bullicio">bullicio</button> de los perros moribundos, cedió la tranca, saltó el pestillo y los primeros hombres irrumpieron en la habitación, el Senador alcanzó a hacer seis disparos antes de perder el conocimiento. Tadeo Céspedes creyó estar soñando al ver un ángel coronado de jazmines que sostenía en los brazos a un viejo agonizante, mientras su blanco vestido se empapaba de rojo, pero no le alcanzó la piedad para una segunda mirada, porque venía borracho de violencia y enervado por varias horas de combate.
            </p>
            <br>
            <p class="text-paragraph">
    ...
    <script src="../../js/definitions-3.js"></script>
</body>
</html>